...
# Get the directory of the current file and construct path to data directory
...
SO_ARM100_ROS2_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{_ASSETS_ROOT}/Robots/so_arm100_ros2/so_arm100.usd",
        activate_contact_sensors=False,                 # Adjust based on need
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "jaw_joint":            0.4,       # Open position safely within joint limits
        },
        # Set initial joint velocities to zero
        joint_vel={".*": 0.0},
    ),
